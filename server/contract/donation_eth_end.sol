...
contract Fundraising {
    ...
    uint256 public finishTime = block.timestamp + 20 minutes;

    constructor(uint256 _targetAmount) {
        targetAmount = _targetAmount;
        owner = msg.sender;
        title = "Make Recycleable Uniforms Fund";
        img_url = "https://t1.daumcdn.net/news/202207/02/interfootball/20220702094506110fvgu.jpg";
    }
